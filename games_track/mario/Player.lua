...
function Player:checkLeftCollision()
    if self.map:tileAt(self.x - 1, self.y).id == POLE_TOP or
    self.map:tileAt(self.x - 1, self.y).id == POLE_MIDDLE or
    self.map:tileAt(self.x - 1, self.y).id == POLE_BOTTOM or
    self.map:tileAt(self.x - 1, self.y).id == TILE_FLAG then 
        love.event.quit()
        victory = 1
    end
    if self.dx < 0 then
...
function Player:checkRightCollision()
    if self.map:tileAt(self.x + self.width, self.y).id == POLE_TOP or
    self.map:tileAt(self.x + self.width, self.y).id == POLE_MIDDLE or
    self.map:tileAt(self.x + self.width, self.y).id == POLE_BOTTOM or
    self.map:tileAt(self.x + self.width, self.y).id == TILE_FLAG then 
        victory = 1
    end
    if self.dx > 0 then
        -- check if there's a tile directly beneath us
